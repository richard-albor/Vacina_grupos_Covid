...
<html>
    <head>
        ...
        <title>Vacinas - Duendes Flow</title>        
    ...
    <body id="page-top">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container col-md-6 col-sm-12">
                        <!-- Masthead Heading-->
                        <h4 class=" text-uppercase mb-0">Vacinas Cadastradas</h4>
        ...
        <%
            List<Vacina> grupoLista = RepositorioVacina.getCurrentInstance().readAll();
        %>
        ...
        <div class="container p-3">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    %>
                    <button id="btn-modal-topo" class="btn btn-success" onclick="modalCadastrarOpen()">Cadastrar Nova Vacina</button>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <table class="table table-striped table-dark">
                        ...
                        <%
                            for (Vacina vacina : grupoLista) {
                        %>
                        <tbody>

                            <tr>
                                <td><%=vacina.getId()%></td>
                                <td><%=vacina.getNome()%></td>
                                <td><%=vacina.getFabricante()%></td>
                                <td><%=vacina.getTempoEntreAplicacoes()%></td>
                                <td><%=vacina.getQuantidadeAplicacoes()%></td>
                                <td>
                                    <a class="m-1" href="VacinaServlet?codigo=<%=vacina.getId()%>&redirect=visualiza">visualizar</a>
                                    <a class="m-1" href="VacinaServlet?codigo=<%=vacina.getId()%>&redirect=atualiza">atualizar</a>
                                    <a class="m-1" href="#" onclick="deleteGrupo(<%= vacina.getId()%>)">deletar</a>
                                </td>
                            </tr>
                        </tbody>
                        <%
		...
		<%@include file="visualiza-vacina.jsp"%>		
		<br />		
	...
	<div id="modalCadastrar"
		...
		<%@include file="cadastra-vacina.jsp"%>
