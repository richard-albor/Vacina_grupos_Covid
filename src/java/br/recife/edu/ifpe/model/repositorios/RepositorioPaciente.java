...
public class RepositorioPaciente {
    ...
    private RepositorioPaciente(){
      ...
      static {
   		...
   		p.setId(01);
                p.setNome("leonor");
                p.setDataNascimento(new Date("04/03/1963"));
                p.setCaracteristicasIndividuais("Agitado");
                p.setGrupo(RepositorioGrupo.getCurrentInstance().read(RepositorioGrupo.getCurrentInstance().qualMeuGrupo(58)));
