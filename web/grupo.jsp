...
<html>
    <head>
        ...
        <title>Grupos - Duendes Flow</title>        
    ...
    <body id="page-top">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container col-md-6 col-sm-12">
                        <!-- Masthead Heading-->
                        <h4 class=" text-uppercase mb-0">Grupos Cadastrados</h4>
        ...
        <%
            List<Grupo> grupoLista = RepositorioGrupo.getCurrentInstance().readAll();
        %>
        ...
        <div class="container p-3">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    %>
                    <button id="btn-modal-topo" class="btn btn-success" onclick="modalCadastrarOpen()">Cadastrar Novo Grupo</button>
                </div>
            </div>
        </div>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <table class="table table-striped table-dark">
                        ...
                        <%
                            for (Grupo grupo : grupoLista) {
                        %>
                        <tbody>

                            <tr>
                                <td><%=grupo.getId()%></td>
                                <td><%=grupo.getDenominacao()%></td>
                                <td><%=grupo.getIdadeMinima()%></td>
                                <td><%=grupo.getIdadeMaxima()%></td>
                                <td>
                                    <a class="m-1" href="GrupoServlet?codigo=<%=grupo.getId()%>&redirect=visualiza">visualizar</a>
                                    <a class="m-1" href="GrupoServlet?codigo=<%=grupo.getId()%>&redirect=atualiza">atualizar</a>
                                    <a class="m-1" href="#" onclick="deleteGrupo(<%= grupo.getId()%>)">deletar</a>
                                </td>
                            </tr>
                        </tbody>
                        <%
		...
		<%@include file="visualiza-grupo.jsp"%>		
		<br />		
	...
	<div id="modalCadastrar"
		...
		<%@include file="cadastra-grupo.jsp"%>
	...
	<%}%>
		...
		function deleteGrupo(id) {
                fetch("GrupoServlet?id=" + id, {method: 'delete'}).then(function (response) {
                    location.reload();
                });
            }
